...
namespace ResembleAI
{
    public partial class SubpackageAudioEditClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_CreateAudioEditServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_CreateAudioEditSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_CreateAudioEditSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_CreateAudioEditSecurityRequirement0,
            };
        partial void PrepareCreateAudioEditArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ResembleAI.CreateAudioEditRequest request);
        partial void PrepareCreateAudioEditRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ResembleAI.CreateAudioEditRequest request);
        partial void ProcessCreateAudioEditResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateAudioEditResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AudioEditCreateAudioEditResponse200> CreateAudioEditAsync(

            global::ResembleAI.CreateAudioEditRequest request,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateAudioEditAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AudioEditCreateAudioEditResponse200>> CreateAudioEditAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAudioEditArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAudioEditSecurityRequirements,
                operationName: "CreateAudioEditAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_CreateAudioEditServers,
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __httpRequestContent.Add(
                                ...
                                name: "\"input_audio\"",
                                fileName: request.InputAudioname != null ? $"\"{request.InputAudioname}\"" : string.Empty);
                            if (__contentInputAudio.Headers.ContentDisposition != null)
                            {
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateAudioEdit",
                                methodName: "CreateAudioEditAsync",
                                pathTemplate: "\"/edit\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAudioEditResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateAudioEditResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.AudioEditCreateAudioEditResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AudioEditCreateAudioEditResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.AudioEditCreateAudioEditResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AudioEditCreateAudioEditResponse200> CreateAudioEditAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.CreateAudioEditRequest
            {
            ...
            return await CreateAudioEditAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            inputAudio = inputAudio ?? throw new global::System.ArgumentNullException(nameof(inputAudio));
            var request = new global::ResembleAI.CreateAudioEditRequest
            {
                InputAudio = global::System.Array.Empty<byte>(),
                InputAudioname = inputAudioname,
                OriginalTranscript = originalTranscript,
                TargetTranscript = targetTranscript,
                VoiceUuid = voiceUuid,
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            var __httpRequestContent = new global::System.Net.Http.MultipartFormDataContent();
                            var __contentInputAudio = new global::System.Net.Http.StreamContent(inputAudio);
                            __contentInputAudio.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.InputAudioname is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.InputAudioname) ?? string.Empty).ToLowerInvariant() switch
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ResembleAI.AudioEditCreateAudioEditResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ResembleAI.AudioEditCreateAudioEditResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
