...
namespace ResembleAI
{
    public partial class VoicesClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_BuildVoiceServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_BuildVoiceSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_BuildVoiceSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_BuildVoiceSecurityRequirement0,
            };
        partial void PrepareBuildVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceUuid,
            global::ResembleAI.BuildVoiceRequest request);
        partial void PrepareBuildVoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string voiceUuid,
            global::ResembleAI.BuildVoiceRequest request);
        partial void ProcessBuildVoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBuildVoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.VoicesBuildVoiceResponse200> BuildVoiceAsync(
            string voiceUuid,
        ...
        {
            var __response = await BuildVoiceAsResponseAsync(
                voiceUuid: voiceUuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.VoicesBuildVoiceResponse200>> BuildVoiceAsResponseAsync(
            string voiceUuid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BuildVoiceSecurityRequirements,
                operationName: "BuildVoiceAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                path: $"/voices/{voiceUuid}/build",
                                baseUri: ResolveBaseUri(
                                servers: s_BuildVoiceServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BuildVoiceAsync",
                                pathTemplate: "$\"/voices/{voiceUuid}/build\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBuildVoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.VoicesBuildVoiceResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.VoicesBuildVoiceResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.VoicesBuildVoiceResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.VoicesBuildVoiceResponse200> BuildVoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.BuildVoiceRequest
            {
                Fill = fill,
            };

            return await BuildVoiceAsync(
                voiceUuid: voiceUuid,
                request: __request,
                requestOptions: requestOptions,
