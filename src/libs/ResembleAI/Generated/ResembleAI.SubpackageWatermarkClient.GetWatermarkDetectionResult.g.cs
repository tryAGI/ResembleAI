...
namespace ResembleAI
{
    public partial class SubpackageWatermarkClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_GetWatermarkDetectionResultServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_GetWatermarkDetectionResultSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_GetWatermarkDetectionResultSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_GetWatermarkDetectionResultSecurityRequirement0,
            };
        partial void PrepareGetWatermarkDetectionResultArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid);
        partial void PrepareGetWatermarkDetectionResultRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid);
        partial void ProcessGetWatermarkDetectionResultResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWatermarkDetectionResultResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get watermark detection result<br/>
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWatermarkDetectionResultArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWatermarkDetectionResultSecurityRequirements,
                operationName: "GetWatermarkDetectionResultAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_GetWatermarkDetectionResultServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetWatermarkDetectionResult",
                                methodName: "GetWatermarkDetectionResultAsync",
                                pathTemplate: "$\"/watermark/detect/{uuid}/result\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWatermarkDetectionResultResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWatermarkDetectionResultResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ResembleAI.WatermarkGetWatermarkDetectionResultResponse200.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ResembleAI.WatermarkGetWatermarkDetectionResultResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
