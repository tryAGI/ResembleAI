...
{
    public partial class SubpackageAudioSourceTracingClient
    {

        private static readonly global::ResembleAI.AutoSDKServer[] s_GetAudioSourceTracingServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_GetAudioSourceTracingSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_GetAudioSourceTracingSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_GetAudioSourceTracingSecurityRequirement0,
            };
        partial void PrepareGetAudioSourceTracingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid);
        partial void PrepareGetAudioSourceTracingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid);
        partial void ProcessGetAudioSourceTracingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAudioSourceTracingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get audio source tracing<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AudioSourceTracingGetAudioSourceTracingResponse200> GetAudioSourceTracingAsync(
            string uuid,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAudioSourceTracingAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AudioSourceTracingGetAudioSourceTracingResponse200>> GetAudioSourceTracingAsResponseAsync(
            string uuid,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAudioSourceTracingArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAudioSourceTracingSecurityRequirements,
                operationName: "GetAudioSourceTracingAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_GetAudioSourceTracingServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAudioSourceTracingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAudioSourceTracing",
                                methodName: "GetAudioSourceTracingAsync",
                                pathTemplate: "$\"/audio_source_tracings/{uuid}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAudioSourceTracingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Source tracing report not found
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAudioSourceTracingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.AudioSourceTracingGetAudioSourceTracingResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AudioSourceTracingGetAudioSourceTracingResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.AudioSourceTracingGetAudioSourceTracingResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
