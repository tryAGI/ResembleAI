...
namespace ResembleAI
{
    public partial class CustomPronunciationsClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_UpdatePronunciationServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_UpdatePronunciationSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_UpdatePronunciationSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_UpdatePronunciationSecurityRequirement0,
            };
        partial void PrepareUpdatePronunciationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid uuid,
            global::ResembleAI.UpdatePronunciationRequest request);
        partial void PrepareUpdatePronunciationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid uuid,
            global::ResembleAI.UpdatePronunciationRequest request);
        partial void ProcessUpdatePronunciationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdatePronunciationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.CustomPronunciationsUpdatePronunciationResponse200> UpdatePronunciationAsync(
            global::System.Guid uuid,
        ...
        {
            var __response = await UpdatePronunciationAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.CustomPronunciationsUpdatePronunciationResponse200>> UpdatePronunciationAsResponseAsync(
            global::System.Guid uuid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdatePronunciationArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdatePronunciationSecurityRequirements,
                operationName: "UpdatePronunciationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_UpdatePronunciationServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdatePronunciationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdatePronunciationAsync",
                                pathTemplate: "$\"/pronunciations/{uuid}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdatePronunciationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdatePronunciationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.CustomPronunciationsUpdatePronunciationResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.CustomPronunciationsUpdatePronunciationResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.CustomPronunciationsUpdatePronunciationResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.CustomPronunciationsUpdatePronunciationResponse200> UpdatePronunciationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.UpdatePronunciationRequest
            {
                Active = active,
            };

            return await UpdatePronunciationAsync(
                uuid: uuid,
                request: __request,
                requestOptions: requestOptions,
