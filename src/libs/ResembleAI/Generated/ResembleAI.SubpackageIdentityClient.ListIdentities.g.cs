                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ResembleAI.IdentityListIdentitiesResponse200.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ResembleAI.IdentityListIdentitiesResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
