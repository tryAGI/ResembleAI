...
namespace ResembleAI
{
    public partial class IdentityClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_DeleteIdentityAttachmentServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_DeleteIdentityAttachmentSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_DeleteIdentityAttachmentSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_DeleteIdentityAttachmentSecurityRequirement0,
            };
        partial void PrepareDeleteIdentityAttachmentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid,
            ref int attachmentId);
        partial void PrepareDeleteIdentityAttachmentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid,
            int attachmentId);
        partial void ProcessDeleteIdentityAttachmentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteIdentityAttachmentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.IdentityDeleteIdentityAttachmentResponse204> DeleteIdentityAttachmentAsync(
            string uuid,
            int attachmentId,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteIdentityAttachmentAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.IdentityDeleteIdentityAttachmentResponse204>> DeleteIdentityAttachmentAsResponseAsync(
            string uuid,
            int attachmentId,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteIdentityAttachmentArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteIdentityAttachmentSecurityRequirements,
                operationName: "DeleteIdentityAttachmentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                path: $"/identity/{uuid}/attachments/{attachmentId}",
                                baseUri: ResolveBaseUri(
                                servers: s_DeleteIdentityAttachmentServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteIdentityAttachmentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteIdentityAttachment",
                                methodName: "DeleteIdentityAttachmentAsync",
                                pathTemplate: "$\"/identity/{uuid}/attachments/{attachmentId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteIdentityAttachmentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Identity or attachment not found
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteIdentityAttachmentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.IdentityDeleteIdentityAttachmentResponse204.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.IdentityDeleteIdentityAttachmentResponse204>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.IdentityDeleteIdentityAttachmentResponse204.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
