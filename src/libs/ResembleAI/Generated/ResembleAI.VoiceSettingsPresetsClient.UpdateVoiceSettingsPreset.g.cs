...
namespace ResembleAI
{
    public partial class VoiceSettingsPresetsClient
    {
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_UpdateVoiceSettingsPresetSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_UpdateVoiceSettingsPresetSecurityRequirement0,
            };
        partial void PrepareUpdateVoiceSettingsPresetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid,
            global::ResembleAI.UpdateVoiceSettingsPresetRequest request);
        partial void PrepareUpdateVoiceSettingsPresetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid,
            global::ResembleAI.UpdateVoiceSettingsPresetRequest request);
        partial void ProcessUpdateVoiceSettingsPresetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateVoiceSettingsPresetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.VoiceSettingsPresetsUpdateVoiceSettingsPresetResponse200> UpdateVoiceSettingsPresetAsync(
            string uuid,
        ...
        {
            var __response = await UpdateVoiceSettingsPresetAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.VoiceSettingsPresetsUpdateVoiceSettingsPresetResponse200>> UpdateVoiceSettingsPresetAsResponseAsync(
            string uuid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateVoiceSettingsPresetArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateVoiceSettingsPresetSecurityRequirements,
                operationName: "UpdateVoiceSettingsPresetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateVoiceSettingsPresetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateVoiceSettingsPreset",
                                methodName: "UpdateVoiceSettingsPresetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateVoiceSettingsPresetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateVoiceSettingsPresetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.VoiceSettingsPresetsUpdateVoiceSettingsPresetResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.VoiceSettingsPresetsUpdateVoiceSettingsPresetResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.VoiceSettingsPresetsUpdateVoiceSettingsPresetResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.VoiceSettingsPresetsUpdateVoiceSettingsPresetResponse200> UpdateVoiceSettingsPresetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.UpdateVoiceSettingsPresetRequest
            {
                Name = name,
                Pace = pace,
            ...
            return await UpdateVoiceSettingsPresetAsync(
                uuid: uuid,
                request: __request,
                requestOptions: requestOptions,
