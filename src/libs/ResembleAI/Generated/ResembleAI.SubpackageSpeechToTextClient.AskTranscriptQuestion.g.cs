...
namespace ResembleAI
{
    public partial class SubpackageSpeechToTextClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_AskTranscriptQuestionServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_AskTranscriptQuestionSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_AskTranscriptQuestionSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_AskTranscriptQuestionSecurityRequirement0,
            };
        partial void PrepareAskTranscriptQuestionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid uuid,
            global::ResembleAI.AskTranscriptQuestionRequest request);
        partial void PrepareAskTranscriptQuestionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid uuid,
            global::ResembleAI.AskTranscriptQuestionRequest request);
        partial void ProcessAskTranscriptQuestionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAskTranscriptQuestionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.SpeechToTextAskTranscriptQuestionResponse200> AskTranscriptQuestionAsync(
            global::System.Guid uuid,
        ...
        {
            var __response = await AskTranscriptQuestionAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.SpeechToTextAskTranscriptQuestionResponse200>> AskTranscriptQuestionAsResponseAsync(
            global::System.Guid uuid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAskTranscriptQuestionArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AskTranscriptQuestionSecurityRequirements,
                operationName: "AskTranscriptQuestionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_AskTranscriptQuestionServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAskTranscriptQuestionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AskTranscriptQuestion",
                                methodName: "AskTranscriptQuestionAsync",
                                pathTemplate: "$\"/speech-to-text/{uuid}/ask\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAskTranscriptQuestionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAskTranscriptQuestionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.SpeechToTextAskTranscriptQuestionResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.SpeechToTextAskTranscriptQuestionResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.SpeechToTextAskTranscriptQuestionResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.SpeechToTextAskTranscriptQuestionResponse200> AskTranscriptQuestionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.AskTranscriptQuestionRequest
            {
                Query = query,
            };

            return await AskTranscriptQuestionAsync(
                uuid: uuid,
                request: __request,
                requestOptions: requestOptions,
