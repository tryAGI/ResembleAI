...
namespace ResembleAI
{
    public partial class SubpackageDuetsClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_UpdateDuetVoiceServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_UpdateDuetVoiceSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_UpdateDuetVoiceSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_UpdateDuetVoiceSecurityRequirement0,
            };
        partial void PrepareUpdateDuetVoiceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id,
            global::ResembleAI.UpdateDuetVoiceRequest request);
        partial void PrepareUpdateDuetVoiceRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id,
            global::ResembleAI.UpdateDuetVoiceRequest request);
        partial void ProcessUpdateDuetVoiceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateDuetVoiceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.DuetsUpdateDuetVoiceResponse200> UpdateDuetVoiceAsync(
            int id,
        ...
        {
            var __response = await UpdateDuetVoiceAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.DuetsUpdateDuetVoiceResponse200>> UpdateDuetVoiceAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateDuetVoiceArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateDuetVoiceSecurityRequirements,
                operationName: "UpdateDuetVoiceAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_UpdateDuetVoiceServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateDuetVoice",
                                methodName: "UpdateDuetVoiceAsync",
                                pathTemplate: "$\"/duet_voices/{id}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateDuetVoiceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateDuetVoiceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.DuetsUpdateDuetVoiceResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.DuetsUpdateDuetVoiceResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.DuetsUpdateDuetVoiceResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.DuetsUpdateDuetVoiceResponse200> UpdateDuetVoiceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.UpdateDuetVoiceRequest
            {
                Name = name,
                StylePrompt = stylePrompt,
            };

            return await UpdateDuetVoiceAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
