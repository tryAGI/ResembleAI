...
namespace ResembleAI
{
    public partial class SubpackageVoiceDesignClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_GenerateVoiceDesignServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_GenerateVoiceDesignSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_GenerateVoiceDesignSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_GenerateVoiceDesignSecurityRequirement0,
            };
        partial void PrepareGenerateVoiceDesignArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ResembleAI.GenerateVoiceDesignRequest request);
        partial void PrepareGenerateVoiceDesignRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ResembleAI.GenerateVoiceDesignRequest request);
        partial void ProcessGenerateVoiceDesignResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateVoiceDesignResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.VoiceDesignGenerateVoiceDesignResponse200> GenerateVoiceDesignAsync(

            global::ResembleAI.GenerateVoiceDesignRequest request,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateVoiceDesignAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.VoiceDesignGenerateVoiceDesignResponse200>> GenerateVoiceDesignAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateVoiceDesignArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateVoiceDesignSecurityRequirements,
                operationName: "GenerateVoiceDesignAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_GenerateVoiceDesignServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateVoiceDesignRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateVoiceDesign",
                                methodName: "GenerateVoiceDesignAsync",
                                pathTemplate: "\"/voice-design\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateVoiceDesignResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateVoiceDesignResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.VoiceDesignGenerateVoiceDesignResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.VoiceDesignGenerateVoiceDesignResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.VoiceDesignGenerateVoiceDesignResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.VoiceDesignGenerateVoiceDesignResponse200> GenerateVoiceDesignAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.GenerateVoiceDesignRequest
            {
                UserPrompt = userPrompt,
            };

            return await GenerateVoiceDesignAsync(
                request: __request,
                requestOptions: requestOptions,
