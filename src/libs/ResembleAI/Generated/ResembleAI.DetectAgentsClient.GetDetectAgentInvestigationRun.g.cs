...
namespace ResembleAI
{
    public partial class DetectAgentsClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_GetDetectAgentInvestigationRunServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_GetDetectAgentInvestigationRunSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_GetDetectAgentInvestigationRunSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_GetDetectAgentInvestigationRunSecurityRequirement0,
            };
        partial void PrepareGetDetectAgentInvestigationRunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid,
            ref global::System.Guid runId);
        partial void PrepareGetDetectAgentInvestigationRunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid,
            global::System.Guid runId);
        partial void ProcessGetDetectAgentInvestigationRunResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDetectAgentInvestigationRunResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.DetectAgentsGetDetectAgentInvestigationRunResponse200> GetDetectAgentInvestigationRunAsync(
            string uuid,
            global::System.Guid runId,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetDetectAgentInvestigationRunAsResponseAsync(
                uuid: uuid,
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.DetectAgentsGetDetectAgentInvestigationRunResponse200>> GetDetectAgentInvestigationRunAsResponseAsync(
            string uuid,
            global::System.Guid runId,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDetectAgentInvestigationRunArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDetectAgentInvestigationRunSecurityRequirements,
                operationName: "GetDetectAgentInvestigationRunAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                path: $"/agents/{uuid}/runs/{runId}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetDetectAgentInvestigationRunServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDetectAgentInvestigationRunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetDetectAgentInvestigationRun",
                                methodName: "GetDetectAgentInvestigationRunAsync",
                                pathTemplate: "$\"/agents/{uuid}/runs/{runId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDetectAgentInvestigationRunResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Detect Agent or investigation run not found
                            ...
                            // Detect Agents service unavailable
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDetectAgentInvestigationRunResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.DetectAgentsGetDetectAgentInvestigationRunResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.DetectAgentsGetDetectAgentInvestigationRunResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.DetectAgentsGetDetectAgentInvestigationRunResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
