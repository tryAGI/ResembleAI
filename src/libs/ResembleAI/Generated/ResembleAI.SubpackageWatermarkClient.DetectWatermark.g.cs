...
{
    public partial class SubpackageWatermarkClient
    {

        private static readonly global::ResembleAI.AutoSDKServer[] s_DetectWatermarkServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_DetectWatermarkSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_DetectWatermarkSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_DetectWatermarkSecurityRequirement0,
            };
        partial void PrepareDetectWatermarkArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::ResembleAI.WatermarkDetectPostParametersPrefer? prefer,
            global::ResembleAI.DetectWatermarkRequest request);
        partial void PrepareDetectWatermarkRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ResembleAI.WatermarkDetectPostParametersPrefer? prefer,
            global::ResembleAI.DetectWatermarkRequest request);
        partial void ProcessDetectWatermarkResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDetectWatermarkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.WatermarkDetectWatermarkResponse200> DetectWatermarkAsync(
        ...
        {
            var __response = await DetectWatermarkAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.WatermarkDetectWatermarkResponse200>> DetectWatermarkAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDetectWatermarkArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DetectWatermarkSecurityRequirements,
                operationName: "DetectWatermarkAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_DetectWatermarkServers,
            ...
            if (prefer != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("Prefer", prefer?.ToValueString() ?? string.Empty);
            }
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DetectWatermarkAsync",
                                pathTemplate: "\"/watermark/detect\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDetectWatermarkResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDetectWatermarkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.WatermarkDetectWatermarkResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.WatermarkDetectWatermarkResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.WatermarkDetectWatermarkResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.WatermarkDetectWatermarkResponse200> DetectWatermarkAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.DetectWatermarkRequest
            {
                Url = url,
                CustomMessage = customMessage,
            };

            return await DetectWatermarkAsync(
                prefer: prefer,
                request: __request,
                requestOptions: requestOptions,
