...
namespace ResembleAI
{
    public partial class SubpackageRecordingsClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_UpdateRecordingServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_UpdateRecordingSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_UpdateRecordingSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_UpdateRecordingSecurityRequirement0,
            };
        partial void PrepareUpdateRecordingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceUuid,
            ref string recordingId,
            global::ResembleAI.UpdateRecordingRequest request);
        partial void PrepareUpdateRecordingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string voiceUuid,
            string recordingId,
            global::ResembleAI.UpdateRecordingRequest request);
        partial void ProcessUpdateRecordingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateRecordingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.RecordingsUpdateRecordingResponse200> UpdateRecordingAsync(
            string voiceUuid,
            string recordingId,
        ...
        {
            var __response = await UpdateRecordingAsResponseAsync(
                voiceUuid: voiceUuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.RecordingsUpdateRecordingResponse200>> UpdateRecordingAsResponseAsync(
            string voiceUuid,
            string recordingId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateRecordingArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateRecordingSecurityRequirements,
                operationName: "UpdateRecordingAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                path: $"/voices/{voiceUuid}/recordings/{recordingId}",
                                baseUri: ResolveBaseUri(
                                servers: s_UpdateRecordingServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateRecordingAsync",
                                pathTemplate: "$\"/voices/{voiceUuid}/recordings/{recordingId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateRecordingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateRecordingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.RecordingsUpdateRecordingResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.RecordingsUpdateRecordingResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.RecordingsUpdateRecordingResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.RecordingsUpdateRecordingResponse200> UpdateRecordingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.UpdateRecordingRequest
            {
                Name = name,
                Text = text,
                Emotion = emotion,
            ...
            return await UpdateRecordingAsync(
                voiceUuid: voiceUuid,
                recordingId: recordingId,
                request: __request,
                requestOptions: requestOptions,
