...
namespace ResembleAI
{
    public partial class SubpackageWatermarkClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_ApplyWatermarkServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_ApplyWatermarkSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_ApplyWatermarkSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_ApplyWatermarkSecurityRequirement0,
            };
        ...
        partial void ProcessApplyWatermarkResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareApplyWatermarkArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ApplyWatermarkSecurityRequirements,
                operationName: "ApplyWatermarkAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_ApplyWatermarkServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ApplyWatermarkAsync",
                                pathTemplate: "\"/watermark/apply\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessApplyWatermarkResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::ResembleAI.WatermarkApplyWatermarkResponse200.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::ResembleAI.WatermarkApplyWatermarkResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ApplyWatermarkAsync(
                prefer: prefer,
                request: __request,
                requestOptions: requestOptions,
