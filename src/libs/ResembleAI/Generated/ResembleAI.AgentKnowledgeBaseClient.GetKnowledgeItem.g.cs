...
namespace ResembleAI
{
    public partial class AgentKnowledgeBaseClient
    {
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_GetKnowledgeItemSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_GetKnowledgeItemSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_GetKnowledgeItemSecurityRequirement0,
            };
        partial void PrepareGetKnowledgeItemArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid uuid);
        partial void PrepareGetKnowledgeItemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid uuid);
        partial void ProcessGetKnowledgeItemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetKnowledgeItemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AgentKnowledgeBaseGetKnowledgeItemResponse200> GetKnowledgeItemAsync(
            global::System.Guid uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AgentKnowledgeBaseGetKnowledgeItemResponse200>> GetKnowledgeItemAsResponseAsync(
            global::System.Guid uuid,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetKnowledgeItemArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetKnowledgeItemSecurityRequirements,
                operationName: "GetKnowledgeItemAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_GetKnowledgeItemServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetKnowledgeItemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetKnowledgeItemAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetKnowledgeItemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetKnowledgeItemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AgentKnowledgeBaseGetKnowledgeItemResponse200>(
                                        statusCode: __response.StatusCode,
