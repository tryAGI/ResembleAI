...
namespace ResembleAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::ResembleAI.AutoSDKRetryOptions Retry { get; set; } = new global::ResembleAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::ResembleAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::ResembleAI.IAutoSDKHook>();
        ...
        public global::ResembleAI.AutoSDKClientOptions AddHook(
            global::ResembleAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::ResembleAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::ResembleAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::ResembleAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::ResembleAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::ResembleAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::ResembleAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::ResembleAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::ResembleAI.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::ResembleAI.AutoSDKHook
    {
        /// <inheritdoc />
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::ResembleAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::ResembleAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::ResembleAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::ResembleAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::ResembleAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::ResembleAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::ResembleAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::ResembleAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::ResembleAI.IAutoSDKHook, global::ResembleAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::ResembleAI.AutoSDKHookContext context)
        {
