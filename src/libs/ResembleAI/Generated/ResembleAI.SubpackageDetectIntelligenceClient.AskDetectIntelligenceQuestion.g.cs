...
{
    public partial class SubpackageDetectIntelligenceClient
    {

        private static readonly global::ResembleAI.AutoSDKServer[] s_AskDetectIntelligenceQuestionServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_AskDetectIntelligenceQuestionSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_AskDetectIntelligenceQuestionSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_AskDetectIntelligenceQuestionSecurityRequirement0,
            };
        partial void PrepareAskDetectIntelligenceQuestionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid,
            global::ResembleAI.AskDetectIntelligenceQuestionRequest request);
        partial void PrepareAskDetectIntelligenceQuestionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid,
            global::ResembleAI.AskDetectIntelligenceQuestionRequest request);
        partial void ProcessAskDetectIntelligenceQuestionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAskDetectIntelligenceQuestionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.DetectIntelligenceAskDetectIntelligenceQuestionResponse202> AskDetectIntelligenceQuestionAsync(
            string uuid,
        ...
        {
            var __response = await AskDetectIntelligenceQuestionAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.DetectIntelligenceAskDetectIntelligenceQuestionResponse202>> AskDetectIntelligenceQuestionAsResponseAsync(
            string uuid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAskDetectIntelligenceQuestionArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AskDetectIntelligenceQuestionSecurityRequirements,
                operationName: "AskDetectIntelligenceQuestionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_AskDetectIntelligenceQuestionServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAskDetectIntelligenceQuestionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AskDetectIntelligenceQuestion",
                                methodName: "AskDetectIntelligenceQuestionAsync",
                                pathTemplate: "$\"/detects/{uuid}/intelligence\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAskDetectIntelligenceQuestionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAskDetectIntelligenceQuestionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.DetectIntelligenceAskDetectIntelligenceQuestionResponse202.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.DetectIntelligenceAskDetectIntelligenceQuestionResponse202>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.DetectIntelligenceAskDetectIntelligenceQuestionResponse202.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.DetectIntelligenceAskDetectIntelligenceQuestionResponse202> AskDetectIntelligenceQuestionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.AskDetectIntelligenceQuestionRequest
            {
                Query = query,
            };

            return await AskDetectIntelligenceQuestionAsync(
                uuid: uuid,
                request: __request,
                requestOptions: requestOptions,
