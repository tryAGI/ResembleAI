...
namespace ResembleAI
{
    public partial class TextDetectionClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_CreateTextDetectionServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_CreateTextDetectionSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_CreateTextDetectionSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_CreateTextDetectionSecurityRequirement0,
            };
        partial void PrepareCreateTextDetectionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::ResembleAI.TextDetectPostParametersPrefer? prefer,
            global::ResembleAI.TextDetectRequest request);
        partial void PrepareCreateTextDetectionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ResembleAI.TextDetectPostParametersPrefer? prefer,
            global::ResembleAI.TextDetectRequest request);
        partial void ProcessCreateTextDetectionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTextDetectionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.TextDetectResponse> CreateTextDetectionAsync(
        ...
        {
            var __response = await CreateTextDetectionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.TextDetectResponse>> CreateTextDetectionAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTextDetectionArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTextDetectionSecurityRequirements,
                operationName: "CreateTextDetectionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_CreateTextDetectionServers,
            ...
            if (prefer != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTextDetectionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTextDetection",
                                methodName: "CreateTextDetectionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTextDetectionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid request: missing text, text over 100,000 characters, fewer than 25 words, invalid `thinking` or `threshold`, or malformed `callback_url`.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTextDetectionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.TextDetectResponse> CreateTextDetectionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.TextDetectRequest
            {
                Text = text,
                Thinking = thinking,
                Threshold = threshold,
            ...
            return await CreateTextDetectionAsync(
                prefer: prefer,
                request: __request,
                requestOptions: requestOptions,
