...
namespace ResembleAI
{
    public partial class SubpackageTextToSpeechClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_StreamSynthesizeServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_StreamSynthesizeSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_StreamSynthesizeSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_StreamSynthesizeSecurityRequirement0,
            };
        partial void PrepareStreamSynthesizeArguments(
        ...
        partial void PrepareStreamSynthesizeRequest(
            ...
            global::ResembleAI.StreamSynthesizeRequest request);
        partial void ProcessStreamSynthesizeResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> StreamSynthesizeAsync(

            global::ResembleAI.StreamSynthesizeRequest request,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await StreamSynthesizeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> StreamSynthesizeAsStreamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStreamSynthesizeArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StreamSynthesizeSecurityRequirements,
                operationName: "StreamSynthesizeAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_StreamSynthesizeServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareStreamSynthesizeRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamSynthesize",
                                methodName: "StreamSynthesizeAsync",
                                pathTemplate: "\"/stream\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStreamSynthesizeResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::ResembleAI.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<byte[]>> StreamSynthesizeAsResponseAsync(
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStreamSynthesizeResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                ...
                                try
                                {
                                    ...
                                    return new global::ResembleAI.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> StreamSynthesizeAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.StreamSynthesizeRequest
            {
                VoiceUuid = voiceUuid,
                Data = data,
            ...
            return await StreamSynthesizeAsync(
                request: __request,
                requestOptions: requestOptions,
