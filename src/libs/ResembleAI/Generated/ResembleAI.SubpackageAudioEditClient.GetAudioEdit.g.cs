...
namespace ResembleAI
{
    public partial class SubpackageAudioEditClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_GetAudioEditServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_GetAudioEditSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_GetAudioEditSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_GetAudioEditSecurityRequirement0,
            };
        partial void PrepareGetAudioEditArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string audioEditUuid);
        partial void PrepareGetAudioEditRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string audioEditUuid);
        partial void ProcessGetAudioEditResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAudioEditResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AudioEditGetAudioEditResponse200> GetAudioEditAsync(
            string audioEditUuid,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAudioEditAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AudioEditGetAudioEditResponse200>> GetAudioEditAsResponseAsync(
            string audioEditUuid,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAudioEditArguments(
                httpClient: HttpClient,
                audioEditUuid: ref audioEditUuid);


            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetAudioEditSecurityRequirements,
                operationName: "GetAudioEditAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                path: $"/edit/{audioEditUuid}",
                                baseUri: ResolveBaseUri(
                                servers: s_GetAudioEditServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAudioEdit",
                                methodName: "GetAudioEditAsync",
                                pathTemplate: "$\"/edit/{audioEditUuid}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAudioEditResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.AudioEditGetAudioEditResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AudioEditGetAudioEditResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.AudioEditGetAudioEditResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
