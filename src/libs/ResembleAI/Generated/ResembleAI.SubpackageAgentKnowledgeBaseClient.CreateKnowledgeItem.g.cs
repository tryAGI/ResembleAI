...
namespace ResembleAI
{
    public partial class SubpackageAgentKnowledgeBaseClient
    {
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_CreateKnowledgeItemSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_CreateKnowledgeItemSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_CreateKnowledgeItemSecurityRequirement0,
            };
        partial void PrepareCreateKnowledgeItemArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::ResembleAI.CreateKnowledgeItemRequest request);
        partial void PrepareCreateKnowledgeItemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::ResembleAI.CreateKnowledgeItemRequest request);
        partial void ProcessCreateKnowledgeItemResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateKnowledgeItemResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AgentKnowledgeBaseCreateKnowledgeItemResponse201> CreateKnowledgeItemAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AgentKnowledgeBaseCreateKnowledgeItemResponse201>> CreateKnowledgeItemAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateKnowledgeItemArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateKnowledgeItemSecurityRequirements,
                operationName: "CreateKnowledgeItemAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::ResembleAI.PathBuilder(
                                ...
                                servers: s_CreateKnowledgeItemServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateKnowledgeItemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateKnowledgeItemAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateKnowledgeItemResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateKnowledgeItemResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.AgentKnowledgeBaseCreateKnowledgeItemResponse201>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AgentKnowledgeBaseCreateKnowledgeItemResponse201> CreateKnowledgeItemAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::ResembleAI.CreateKnowledgeItemRequest
            {
                Title = title,
            ...
            return await CreateKnowledgeItemAsync(
                request: __request,
                requestOptions: requestOptions,
