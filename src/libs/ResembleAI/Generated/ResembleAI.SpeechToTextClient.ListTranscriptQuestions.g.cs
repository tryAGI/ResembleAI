...
namespace ResembleAI
{
    public partial class SpeechToTextClient
    {
        ...
        private static readonly global::ResembleAI.AutoSDKServer[] s_ListTranscriptQuestionsServers = new global::ResembleAI.AutoSDKServer[]
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement s_ListTranscriptQuestionsSecurityRequirement0 =
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_ListTranscriptQuestionsSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_ListTranscriptQuestionsSecurityRequirement0,
            };
        partial void PrepareListTranscriptQuestionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid uuid,
            ref int page,
            ref int? perPage);
        partial void PrepareListTranscriptQuestionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid uuid,
            int page,
            int? perPage);
        partial void ProcessListTranscriptQuestionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListTranscriptQuestionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.SpeechToTextListTranscriptQuestionsResponse200> ListTranscriptQuestionsAsync(
            global::System.Guid uuid,
            int page,
            int? perPage = default,
        ...
        {
            var __response = await ListTranscriptQuestionsAsResponseAsync(
                uuid: uuid,
                page: page,
                perPage: perPage,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.SpeechToTextListTranscriptQuestionsResponse200>> ListTranscriptQuestionsAsResponseAsync(
            global::System.Guid uuid,
            int page,
            int? perPage = default,
            global::ResembleAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListTranscriptQuestionsArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListTranscriptQuestionsSecurityRequirements,
                operationName: "ListTranscriptQuestionsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListTranscriptQuestions",
                                methodName: "ListTranscriptQuestionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListTranscriptQuestionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListTranscriptQuestionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.SpeechToTextListTranscriptQuestionsResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.SpeechToTextListTranscriptQuestionsResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.SpeechToTextListTranscriptQuestionsResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
