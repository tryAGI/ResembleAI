...
namespace ResembleAI
{
    public partial class CustomPronunciationsClient
    {
        ...
        private static readonly global::ResembleAI.EndPointSecurityRequirement[] s_ListPronunciationsSecurityRequirements =
            new global::ResembleAI.EndPointSecurityRequirement[]
            {                s_ListPronunciationsSecurityRequirement0,
            };
        partial void PrepareListPronunciationsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? language,
            ref string? domain,
            ref global::ResembleAI.PronunciationsGetParametersStatus? status,
            ref bool? active);
        partial void PrepareListPronunciationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? language,
            string? domain,
            global::ResembleAI.PronunciationsGetParametersStatus? status,
            bool? active);
        partial void ProcessListPronunciationsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListPronunciationsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ResembleAI.CustomPronunciationsListPronunciationsResponse200> ListPronunciationsAsync(
        ...
        {
            var __response = await ListPronunciationsAsResponseAsync(
                language: language,
                domain: domain,
                status: status,
                active: active,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ResembleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.CustomPronunciationsListPronunciationsResponse200>> ListPronunciationsAsResponseAsync(
            string? language = default,
            string? domain = default,
            global::ResembleAI.PronunciationsGetParametersStatus? status = default,
            bool? active = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListPronunciationsArguments(
            ...
            var __authorizations = global::ResembleAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListPronunciationsSecurityRequirements,
                operationName: "ListPronunciationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListPronunciationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ResembleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListPronunciationsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListPronunciationsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ResembleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListPronunciationsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::ResembleAI.CustomPronunciationsListPronunciationsResponse200.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::ResembleAI.AutoSDKHttpResponse<global::ResembleAI.CustomPronunciationsListPronunciationsResponse200>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::ResembleAI.CustomPronunciationsListPronunciationsResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
