...
The ResembleAI SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package ResembleAI
```
...
using var client = new ResembleAIClient(
    apiKey: Environment.GetEnvironmentVariable("RESEMBLEAI_API_KEY")!);
